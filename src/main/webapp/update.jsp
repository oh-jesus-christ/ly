...
<div id="container" style="margin-top: 30px" class="container">
     <form class="form-horizontal" action="update.do" method="post" > 
     	...
     	<div class="form-group">
			...
			<div class="col-md-3 ">
				<input type="text" class="form-control"  required="required" name="uid" value="${user.uid}">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-3 ">
			   ...
			   <input type="text" class="form-control" required="required" name="uname" value="${user.uname}">
		...
		<div class="form-group">
			...
			<div class="col-md-3 ">
			   ...
			   <input type="text" class="form-control" required="required" name="deptid" value="${user.deptid}">
			</div>
		</div>
              ...
              <div class="form-group">
                <label  class="col-md-2 col-sm-2 control-label" style="margin-left:80px;">uage：</label>
              	 <div class="col-md-3 " >
					<input type="text" class="form-control"  required="required" name="uage" value="${user.uage}">
				</div>
            </div>
